...
Indeed, it's clear that both models tend to struggle with countries with "hybrid" institutions (apparently democratic but with significant problems), which tend to be hard for human coders too, as is evident from @fig-vdem-rmse. But GPT 3.5 struggles less!
